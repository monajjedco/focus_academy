var Index = function () {
    ...
    return {
        ...
        initMiniCharts: function () {
            ...
            $('.easy-pie-chart .number.yellow').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
            ...
            $('.easy-pie-chart .number.orange').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
                barColor: Metronic.getBrandColor('orange')
            });

            $('.easy-pie-chart .number.grey').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
