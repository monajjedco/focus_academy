...
(function (factory) {
  ...
  var settings = {
    ...
    options: {
      ...
      // language
      lang: 'ar-AR',                // language 'en-US', 'ko-KR', ...
      direction: null,              // text direction, ex) 'rtl'

      // toolbar
      toolbar: [
        ['style', ['style']],
        ['font', ['bold', 'italic', 'underline', 'superscript33', 'subscript33', 'strikethrough33', 'clear']],
        ['fontname', ['fontname']],
  ...
  var Renderer = function () {
    ...
    var tplShortcutText = function (lang) {
      var body = '<tr><td>âŒک + B</td><td>' + lang.font.bold + '</td></tr>' +
                 '<tr><td>âŒک + I</td><td>' + lang.font.italic + '</td></tr>' +
                 '<tr><td>âŒک + U</td><td>' + lang.font.underline + '</td></tr>' +
                 '<tr><td>âŒک + â‡§ + S</td><td>' + lang.font.strikethrough + '</td></tr>' +
                 '<tr><td>âŒک + \\</td><td>' + lang.font.clear + '</td></tr>';

      return tplShortcut(lang.shortcut.textFormatting, body);
    };

    var tplShortcutAction = function (lang) {
      var body = '<tr><td>âŒک + Z</td><td>' + lang.history.undo + '</td></tr>' +
                 '<tr><td>âŒک + â‡§ + Z</td><td>' + lang.history.redo + '</td></tr>' +
                 '<tr><td>âŒک + ]</td><td>' + lang.paragraph.indent + '</td></tr>' +
                 '<tr><td>âŒک + [</td><td>' + lang.paragraph.outdent + '</td></tr>' +
                 '<tr><td>âŒک + ENTER</td><td>' + lang.hr.insert + '</td></tr>';

      return tplShortcut(lang.shortcut.action, body);
    };

    var tplShortcutPara = function (lang) {
      var body = '<tr><td>âŒک + â‡§ + L</td><td>' + lang.paragraph.left + '</td></tr>' +
                 '<tr><td>âŒک + â‡§ + E</td><td>' + lang.paragraph.center + '</td></tr>' +
                 '<tr><td>âŒک + â‡§ + R</td><td>' + lang.paragraph.right + '</td></tr>' +
                 '<tr><td>âŒک + â‡§ + J</td><td>' + lang.paragraph.justify + '</td></tr>' +
                 '<tr><td>âŒک + â‡§ + NUM7</td><td>' + lang.lists.ordered + '</td></tr>' +
                 '<tr><td>âŒک + â‡§ + NUM8</td><td>' + lang.lists.unordered + '</td></tr>';

      return tplShortcut(lang.shortcut.paragraphFormatting, body);
    };

    var tplShortcutStyle = function (lang) {
      var body = '<tr><td>âŒک + NUM0</td><td>' + lang.style.normal + '</td></tr>' +
                 '<tr><td>âŒک + NUM1</td><td>' + lang.style.h1 + '</td></tr>' +
                 '<tr><td>âŒک + NUM2</td><td>' + lang.style.h2 + '</td></tr>' +
                 '<tr><td>âŒک + NUM3</td><td>' + lang.style.h3 + '</td></tr>' +
                 '<tr><td>âŒک + NUM4</td><td>' + lang.style.h4 + '</td></tr>' +
                 '<tr><td>âŒک + NUM5</td><td>' + lang.style.h5 + '</td></tr>' +
                 '<tr><td>âŒک + NUM6</td><td>' + lang.style.h6 + '</td></tr>';
    ...
    var replaceMacKeys = function (sHtml) {
      return sHtml.replace(/âŒک/g, 'Ctrl').replace(/â‡§/g, 'Shift');
    };
    ...
    var tplDialogs = function (lang, options) {
      ...
      var tplHelpDialog = function () {
        var body = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + lang.shortcut.close + '</a>' +
                   ...
                   '<p class="text-center">' +
                     '<a href="//hackerwins.github.io/summernote/" target="_blank">Summernote 0.5.10</a> آ· ' +
                     '<a href="//github.com/HackerWins/summernote" target="_blank">Project</a> آ· ' +
    ...
    var representShortcut = function (str) {
      if (agent.isMac) {
        str = str.replace('CMD', 'âŒک').replace('SHIFT', 'â‡§');
      }
    ...
    this.createLayoutByAirMode = function ($holder, options) {
      ...
      var langInfo = $.extend($.summernote.lang['ar-AR'], $.summernote.lang[options.lang]);
